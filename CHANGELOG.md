...
- Use `rimraf` and TypeScript for the production build, and add a project structure guide.
...
- Expand the npm package description and keywords so Atlas Home Security and RISCO Cloud users can find the plugin with product and alarm-system searches.
